...
const BUILD_ITEM_IDS: Array[String] = ["rose", "turret1", "turret_epine", "wall", "ronce", COUNTER_ID, PASTEQUE_ID]
...
const ITEM_IDS: Array[String] = ["rose", "turret1", "turret_epine", "wall", "ronce", COUNTER_ID, PASTEQUE_ID, SEED_ITEM_ID, "sword", "bomb", "spray", "beam"]
