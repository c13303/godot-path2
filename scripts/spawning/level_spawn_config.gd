...
@export var tool_shop_available_items: Array[StringName] = [&"rose", &"turret_epine", &"ronce", &"fence"]
...
@export var shop_available_items: Array[StringName] = [&"rose", &"turret_epine", &"ronce", &"fence", &"seed", &"spray", &"beam", &"sword", &"bomb"]
